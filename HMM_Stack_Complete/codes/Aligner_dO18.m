function [core_return,figs] = Aligner_dO18(files,data,rhos,core_param,stack_param)
...
while ~done
    ...
    parfor index = 1:P
        ...
        [BMatrix,max_T] = backward_algorithm(data,stack_param,core_param,index,rhos);
        ...
        new_core_param(index) = core_parameter(fMatrix,BMatrix,data,index,PMatrix,QMatrix,core_param,stack_param);
...
figs = plotting_results_dO18(PMatrix_Total,data,stack_param,files);
