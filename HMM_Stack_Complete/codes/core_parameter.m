function [new_core_param] = core_parameter(fMatrix,BMatrix,data,index,PMatrix,QMatrix,core_param,stack_param)
...
temp1 = age_stack*PMatrix(:,end) - age_stack*PMatrix(:,1);
temp2 = depth(end) - depth(1);
new_core_param.R = (0.01+temp1)/(0.01+temp2);

new_core_param.shift = sum(del_O18'-mu(1:max_T)*PMatrix)/length(del_O18);
